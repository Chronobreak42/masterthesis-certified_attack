...
def run_global_attack(epsilon, m, storage, pert_adj_storage_type, pert_attr_storage_type,
                      pert_params, adversary, model_label, use_cert, grid_radii: Optional[np.ndarray] = None):
    ...
    if pert_adj is not None and pert_attr is not None:
        ...
        adversary.attack(n_perturbations, use_cert = use_cert, grid_radii = grid_radii)
